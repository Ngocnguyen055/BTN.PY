    ...
    if response_player.status_code == 200:
        ...
        if check_goalkeeping_table is None:
            ...
            cv_player.extend([
                ...
                res1.find('td', {'data-stat': 'matches'}).text
            ])
...
table = [
    ...
    'GA90', 'Save%', 'CS%', 'Matches',
    'SoT%', 'SoT/90', 'G/sh', 'Dist',
    'Cmp', 'Cmp%', 'TotDist', 'Cmp%_S', 'Cmp%_M', 'Cmp%_L', 'KP', 'Pass_1/3', 'PPA', 'CrsPA', 'Pass_PrgP',
    'SCA', 'SCA90', 'GCA', 'GCA90',
    'Tkl', 'TklW', 'Chal', 'Chal_Lost', 'Blocks', 'Block_Sh', 'Block_Pass', 'Int',
    'Touches', 'Def_Pen', 'Def_3rd', 'Mid_3rd', 'Att_3rd', 'Att_Pen', 'Take_Ons', 'Succ%', 'Tkld%', 'Carries', 'Carry_ProDist', 'Carry_PrgC', 'Carry_1/3', 'CPA', 'Mis', 'Dis', 'Rec', 'Rec_PrgR',
...
df.to_csv('deadline-1/results.csv', index=True)